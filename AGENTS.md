...
This project is indexed by GitNexus as **holmevann** (561 symbols, 1032 relationships, 40 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/holmevann/process/{processName}` — trace the full execution flow step by step
...
| Resource                                   | Use for                                  |
| ------------------------------------------ | ---------------------------------------- |
| `gitnexus://repo/holmevann/context`        | Codebase overview, check index freshness |
| `gitnexus://repo/holmevann/clusters`       | All functional areas                     |
| `gitnexus://repo/holmevann/processes`      | All execution flows                      |
| `gitnexus://repo/holmevann/process/{name}` | Step-by-step execution trace             |
